    ...
    <div className="min-h-[90vh] flex items-center justify-center bg-slate-50 px-6">
      <div className="w-full max-w-md flex flex-col gap-6">
            ...
            {status.success ? (
              <div className="text-center space-y-4 animate-in fade-in zoom-in duration-300">
                ...
                <Link href="/login">
                  ...
                  >
                    {t("ForgotPasswordPage", "successState.button")}
                  </Button>
                </Link>
              </div>
            ) : (
        ...
        <div className="text-center">
          <Link
            href="/login"
            className="text-sm font-bold text-slate-400 hover:text-green-800 transition-colors flex items-center justify-center gap-2"
          >
            <ArrowLeft size={16} />
