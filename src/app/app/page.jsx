...
export default function Dashboard() {
  ...
  const accountCards = [
    { title: t("savings", "SAVINGS"), amount: "$5,010,876.00", acc: ".... 6708", color: "from-green-800 to-green-950" },
    { title: t("checking", "CHECKING"), amount: "$12,450.00", acc: ".... 1234", color: "from-green-800 to-slate-950" },
    { isVirtual: true }
  ]
    ...
    <div className="w-full bg-slate-50 min-h-screen">
      ...
      <header className="p-4 flex justify-between items-center bg-green-900 text-white md:px-8 md:py-6">
        ...
        <div className="flex items-center gap-3">
          <span className="hidden md:block text-sm font-medium opacity-80">{t("welcome", "Welcome back, John")}</span>
